...
HOLDINGS = ['TRIAUSDT', 'QUSDT', 'MAGMAUSDT', 'TRADOORUSDT', 'APRUSDT', 'UAIUSDT', 'DOODUSDT', 'BULLAUSDT', 'JCTUSDT', 'ZECUSDT', 'RAYSOLUSDT', 'XRPUSDT', 'BTCUSDT', 'ETHUSDT', 'SOLUSDT', 'KOMAUSDT', 'VTHOUSDT', 'IOSTUSDT', 'BEATUSDT', 'OPENAIUSDT', 'SNXUSDT', 'SUIUSDT', 'XLMUSDT', 'PUMPUSDT', '1000PEPEUSDT', 'BMTUSDT', 'EIGENUSDT', 'HEIUSDT', 'LINKUSDT', 'RENDERUSDT', 'ROSEUSDT', 'XVGUSDT', 'ANTHROPICUSDT', 'HYPEUSDT', 'CRVUSDT', 'DASHUSDT', 'ARBUSDT', 'INJUSDT', 'DOGEUSDT', 'UNIUSDT', 'JUPUSDT', 'XMRUSDT', 'TAOUSDT', 'REZUSDT', 'FLOCKUSDT', 'ZESTUSDT', 'PONSUSDT', 'MARSCOINUSDT', 'PAXGUSDT', 'FILUSDT', 'MTLUSDT', 'ARKUSDT', 'AINUSDT', 'POWERUSDT']  # "pump" group + ZEC (2026-09-07) + majors/mids expansion (2026-09-11) + HYPE/CRV/DASH/ARB/INJ/DOGE + UNI/JUP/XMR/TAO + REZ/FLOCK/ZEST/PONS/MARSCOIN (2026-09-12) + PAXG/FIL/MTL/ARK/AIN/POWER (2026-09-14, verified TRADING on testnet)
